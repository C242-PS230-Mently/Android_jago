        ...
        viewModelScope.launch {
            ...
            if (answersList != null) {
                val result = questionRepository.predict(
                    q1 = answersList[0], q2 = answersList[1], q3 = answersList[2], q4 = answersList[3], q5 = answersList[4],
                    q6 = answersList[5], q7 = answersList[6], q8 = answersList[7], q9 = answersList[8], q10 = answersList[9],
                    q11 = answersList[10], q12 = answersList[11], q13 = answersList[12], q14 = answersList[13], q15 = answersList[14],
